...
module VCAP::CloudController
  module Diego
    class BindingsSync
      ...
      def sync
        logger.info('run-binding-sync')


        # TODO save external binding as binding model in controller

        # Get all "external bindings" from DB

        # Get all "external binding" from ISM

        # Delete all DB bindings & recreate from ISM.
