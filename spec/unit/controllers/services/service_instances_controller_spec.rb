        ...
        describe 'permissions' do
          {
            ...
            context "as an #{role}" do
              ...
              it "returns #{expected_return_values}" do
                ...
                expect(last_response).to have_status_code(200), "Expected 200, got: #{last_response.status}, role: #{role}"
          ...
          context 'when the user is a member of the org/space this instance exists in' do
            {
              ...
              context "as an #{role}" do
                ...
                it "has a #{expected_status} http status code" do
                  get "/v2/service_instances/#{instance.guid}/shared_from"
                  expect(last_response).to have_status_code(expected_status), "Expected #{expected_status}, got: #{last_response.status}, role: #{role}"
                end
              end
            end
          end
      ...
      describe 'permissions' do
        {
          ...
          context "as an #{role}" do
            ...
            it "returns #{expected_return_value}" do
              get "/v2/service_instances/#{instance.guid}/parameters"
              expect(last_response).to have_status_code(expected_return_value), "Expected #{expected_return_value}, got: #{last_response.status}, role: #{role}"
            end
          end
        end
