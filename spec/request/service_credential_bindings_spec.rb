...
RSpec.describe 'v3 service credential bindings' do
  ...
  describe 'GET /v3/service_credential_bindings/:app_guid' do
    ...
    # {
    #   guid: app_binding.guid,
    #   type: 'app',
    #   created_at: iso8601,
    #   updated_at: iso8601,
    #   name: app_binding.name,
    #   last_operation: {
    #     type: 'create',
    #     state: 'succeeded',
    #     description: 'some description',
    ...
    #   links: {
    #     self: {
    #       href: "#{link_prefix}/v3/service_credential_bindings/#{app_binding.guid}"
    #     },
    #     app: {
    #       href: "#{link_prefix}/v3/apps/#{app_to_bind_to.guid}"
    #     },
    #     service_instance: {
