  ...
  module ServiceBrokers
    module V2
      RSpec.describe 'ResponseParser' do
        ...
        test_pass_through(:unbind, 202,                                                         expected_state: 'in progress')
        test_case(:unbind, 202, broker_empty_json,                                              result: client_result_with_state('in progress'))
        ...
        test_case(:unbind, 202, with_operation.to_json,                                         result: client_result_with_state('in progress').merge(with_operation))
        test_case(:unbind, 202, with_non_string_operation.to_json,                              error: Errors::ServiceBrokerResponseMalformed, description: malformed_response_error(binding_uri, 'The service broker response contained an operation field that was not a string.'))
        test_case(:unbind, 202, with_long_operation.to_json,                                    error: Errors::ServiceBrokerResponseMalformed, description: malformed_response_error(binding_uri, 'The service broker response contained an operation field exceeding 10k characters.'))
