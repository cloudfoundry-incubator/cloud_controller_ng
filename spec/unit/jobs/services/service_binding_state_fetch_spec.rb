  ...
  module Jobs
    module Services
      RSpec.describe ServiceBindingStateFetch, job_context: :worker do
        ...
        let(:service_key) do
          service_binding = ServiceKey.make
          service_binding.service_binding_operation = service_binding_operation
          service_binding
        end
        ...
        describe '#perform' do
          ...
          context 'for ServiceKey' do
            let(:job) { VCAP::CloudController::Jobs::Services::ServiceBindingStateFetch.new(service_binding.guid, user_info, request_attrs, ServiceKey) }
