RSpec.shared_examples 'permissions when organization is suspended' do | success_code |
  before do
  ...
  it_behaves_like 'permissions for single object endpoint', ALL_PERMISSIONS do
    let(:expected_codes_and_responses) { responses_for_org_suspended_space_restricted_update_endpoint success_code: success_code }
  end
end
